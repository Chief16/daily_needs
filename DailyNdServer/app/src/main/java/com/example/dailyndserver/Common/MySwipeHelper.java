package com.example.dailyndserver.Common;
...
import com.example.dailyndserver.callback.MyButtonClickListener;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private View.OnTouchListener onTouchListener = (View.OnTouchListener) (v, motionEvent) -> {
