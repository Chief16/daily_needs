package com.example.dailynd.Adapter;
...
import com.example.dailynd.Callback.IRecyclerClickListener;
...
public class MyFoodListAdapter extends RecyclerView.Adapter<MyFoodListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txt_food_price.setText(new StringBuilder("Rs ").append(foodModelList.get(position).getPrice()));
